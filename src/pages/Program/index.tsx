...
const options = [
    { value: "For Handicap", label: "ForHandicap" },
...
const Programs = (props: any) => {
    document.title = "Programs | Bouden Coach Travel";
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumb title="Programs" pageTitle="Management" />
                                                            ...
                                                            <Tab.Pane eventKey="2">
                                                                ...
                                                                <div>
                                                                    {stops.map((stop) => (
                                                                        <Row>
                                                                            <Col lg={6}>
                                                                                <div className="mb-3" key={stop.id}>
                                                                                    <Form.Label htmlFor="customerName-field">
                                                                                        Name
                                                                                    </Form.Label>
                                                                                    <Form.Control
